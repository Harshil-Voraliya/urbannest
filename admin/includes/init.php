...
define("BASE_DIR", $_SERVER['DOCUMENT_ROOT'] . "/urbannestweb/admin");
define("BASE_URL", "/urbannestweb/admin");

date_default_timezone_set('Asia/Kolkata');

$connection = new PDO("mysql:host=localhost;port=3306;dbname=urbannest", "root", "");

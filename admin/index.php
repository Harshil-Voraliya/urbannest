                  ...
                  <div class="card-body">
                    ...
                    <div class="greeting-user"> 
                      <div class="profile-vector">
                        ...
                        </ul><img class="img-fluid" src="<?= urlOf('assets/images/dashboard/default/profile.png') ?>" alt="">
                        <ul class="vector-image"> 
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon3.png') ?>" alt=""></li>
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon4.png') ?>" alt=""></li>
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon5.png') ?>" alt=""></li>
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon6.png') ?>" alt=""></li>
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon1.png') ?>" alt=""></li>
                          <li> <img src="<?= urlOf('assets/images/dashboard/default/ribbon7.png') ?>" alt=""></li>
                        </ul>
                      </div>
                    ...
                    <div class="table-responsive theme-scrollbar">
                      <table class="table">
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex"><img class="img-fluid align-top circle" src="<?= urlOf('assets/images/dashboard/default/01.png') ?>" alt="">
                          ...
                          <tr> 
                            <td> 
                              <div class="d-flex"><img class="img-fluid align-top circle" src="<?= urlOf('assets/images/dashboard/default/02.png') ?>" alt="">
                          ...
                          <tr> 
                            <td> 
                              <div class="d-flex"><img class="img-fluid align-top circle" src="<?= urlOf('assets/images/dashboard/default/03.png') ?>" alt="">
                          ...
                          <tr>
                            <td> 
                              <div class="d-flex"><img class="img-fluid align-top circle" src="<?= urlOf('assets/images/dashboard/default/04.png') ?>" alt="">
                          ...
                          <tr> 
                            <td> 
                              <div class="d-flex"><img class="img-fluid align-top circle" src="<?= urlOf('assets/images/dashboard/default/05.png') ?>" alt="">
                    ...
                    <div class="activity-timeline todo-timeline">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                          ...
                          <div class="d-flex mt-0"><img class="img-fluid img-30" src="<?= urlOf('assets/images/dashboard/default/todo.png') ?>" alt="">
...
<!-- Mirrored from admin.pixelstrap.com/tivo/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jul 2024 16:24:00 GMT -->
</html>
  <?php

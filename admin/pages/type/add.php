                  ...
                  <div class="card-body">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-12"><br>
                              <input class="form-control" type="text" id="Name" name="Name" placeholder="Enter Property Type" autofocus>
                            </div>
                          </div>
    ...
    <div class="modal" tabindex="-1" id="success">
        <div class="modal-dialog">
          <div class="modal-content bg-dark">
            <div class="modal-header text-white">
              <h5 class="modal-title">Type Added!</h5>
            </div>
      ...
      <div class="modal" tabindex="-1" id="error">
        <div class="modal-dialog">
          <div class="modal-content bg-dark">
            <div class="modal-header text-white">
              <h5 class="modal-title">Type Not Added!</h5>
            </div>
            <div class="modal-footer">
